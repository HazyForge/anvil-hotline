// Package hotline is the transport-agnostic human-decision library used by
// Anvil agents when they need a bounded reply or a scoped discussion before
// continuing. Discord is the first transport.
package hotline
